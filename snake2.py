...
def gameLoop():
    ...
    # Power-up and obstacle positions
    ...
    while not game_over:
        ...
        if powerup_active and not obstacle_active:
            pygame.draw.rect(dis, yellow, [powerupx, powerupy, snake_block, snake_block])
        elif obstacle_active and not powerup_active:
        ...
        if current_time - level_timer >= 30:
            snake_speed = 15
            difficulty_level = 1
            powerup_active = False
            obstacle_active = True
